...
global.OpenAIKey = "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" //login to https://platform.openai.com/account/api-keys to get apikey
...
global.APIKeys = {
   'https://api.zeeoneofc.my.id': 'EowBZfl7z7mVyEG', // 👉 login https://api.zeeoneofc.my.id to get apikey
}
global.sewabotnya = `
